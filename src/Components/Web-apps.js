        ...
        <div className="web-apps-content">
          ...
          <div className="web-apps-examples">
            ...
            <Slide direction="up" delay={200}>
              <Project
                title="MyMDB"
                description="A webapp that  the OMDB api to generate a list of movies based on users search, Movies can be added and removed from users favourites. For the latest version of this I have used tailwind for ease of styling and to make the experience a lot more responsive on mobile (Old version - https://mymdb-newell.netlify.app/)
                "
